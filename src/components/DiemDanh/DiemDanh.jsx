        ...
        <ModelEvent title onClick={handleHiddenDiemDanh}>
            <div className="modal-body">
                <div className="row mt-2 mb-2">
                    ...
                    <div className="col">
                        <div className="timeline-steps aos-init aos-animate" data-aos="fade-up" id="diemdanh-his">
                ...
                <div className="notice_diemdanh">
                    <ul>
                        ...
                        <li>
                            Mỗi ngày sẽ có 1 phần quà random từ 100-200k cho 1 bạn may mắn nhất (Chỉ những ai điểm danh
                            mới được)
                        </li>
